...
/* empty css                      */const imgTorontoDensity = "/mapping-workshops-2023/_app/immutable/assets/toronto-density-33b1c910.png";
const imgOntarioFrench = "/mapping-workshops-2023/_app/immutable/assets/ontario-french-a86bc40b.png";
const imgOntarioLanguage = "/mapping-workshops-2023/_app/immutable/assets/ontario-language-dbd21b05.png";
const imgCensusBoundaries = "/mapping-workshops-2023/_app/immutable/assets/census-boundaries-legend-eg-69844584.png";
const imgSpatialData = "/mapping-workshops-2023/_app/immutable/assets/spatial-data-2dcc30b3.svg";
const imgToronto1909 = "/mapping-workshops-2023/_app/immutable/assets/toronto-1909-b2f68b67.png";
const imgTorontoPortuguese = "/mapping-workshops-2023/_app/immutable/assets/portuguese-toronto-16fe25e7.png";
...
<main><div id="${"title"}"><h1>Mapping Canadian Census Data</h1>
    ...
    <div id="${"text"}"><p><a href="${"https://www12.statcan.gc.ca/census-recensement/index-eng.cfm"}" target="${"_blank"}">Statistics Canada</a> conducts a national census of the population every five years, asking a range of demographic and socio-economic questions. The most recent census was in 2021. 
        ...
        <a${add_attribute("href", imgTorontoDensity, 0)} target="${"_blank"}"><img${add_attribute("src", imgTorontoDensity, 0)} alt="${"toronto-density"}"></a>

        <p>And here&#39;s a simple map of French speakers in Ontario.
        </p>

        <a${add_attribute("href", imgOntarioFrench, 0)} target="${"_blank"}"><img${add_attribute("src", imgOntarioFrench, 0)} alt="${"toronto-french"}"></a>

        <p>Maps like these are pretty easy to make! Let&#39;s learn how.
        </p>
        <p>Specifically, this tutorial covers:
        </p>
        <ul class="${"list"}"><li>an overview of Canadian Census data</li>
            ...
            <li>how to download census data and make custom maps in <a href="${"https://www.qgis.org/en/site/"}" target="${"_blank"}">QGIS</a></li></ul></div>

    <div id="${"text"}"><h2>Canadian Census Data</h2>
        ...
        <p>The are a number of <a href="${"https://www12.statcan.gc.ca/census-recensement/2021/geo/ref/index-eng.cfm"}" target="${"_blank"}">geographic boundaries</a> available with associated census data, ranging in scale from city blocks to the entire country. Below is an example of commonly used boundaries for urban-scale maps and analysis.
        </p>
        <p>Each polygon on this map has associated summary census data. Joining this tabular data to these spatial boundaries allows for making a wide range of maps showing the distribution of demographics and socio-economic variables.
        </p>
    ...
    <div id="${"text"}"><h2>Spatial Data, GIS, and Cartography</h2>
        ...
        <p>Before moving on to how we can make maps of census data, let&#39;s first briefly cover the basics of spatial data and map making.
        </p>
        <p>Spatial data are any data that are a combination of attribute data (i.e. the what) and location data (i.e. the where). When working with census and other urban data, location data are based on reference to the Earth&#39;s surface. Common ways of representing spatial features are as single points, as lines of connected points, as polygons of enclosed lines, or grids of equal size and spacing.
        </p>
        <a${add_attribute("href", imgSpatialData, 0)} target="${"_blank"}"><img${add_attribute("src", imgSpatialData, 0)} alt="${"spatial-data-types"}"></a>
        <p>Spatial data can be symbolized based on its attribute data. This can be based on categorical data (e.g. in the map above, three different colours of lines are used to represent three different types of census boundaries), or this can be based on numeric data (e.g. the map showed at the top of this page shades polygons based on their population density).
        </p>
    ...
    <div id="${"text"}"><h2>Making Census Maps in QGIS</h2>
        ...
        <p>The legend and scale bar were added by going to <i>Project</i>, selecting <i>New Print Layout</i>, and then adding in a map view, legend, and scale bar to the blank page.
        </p>
