...
<svelte:head>
    ...
    <title>GIS Workshop / MUI2000</title>
    <meta name="description" content="GIS workshop for MUI2000">
...
<main>
    ...
    <div id="text">
        ...
        <p>We use Geographic Information Systems (GIS) to analyze, manipulate, and visualize spatial information on a computer.</p>
        
        <p>Why is GIS useful?</p>

        <ul class="list">
            <li>visualize spatial data</li>
        ...
        <p>Data for these workshops can be downloaded from <a href="https://github.com/schoolofcities/mapping-workshops-2023/raw/main/notebooks/qgis-intro/qgis-intro.zip" target="_blank">here</a>.</p>
    ...
    <div id="text">
        ...
        <img width="" src={imgOsmCollege} alt="OpenStreetMap">
        ...
        <img src={imgDemToronto} alt="DEM Toronto">
    ...
    <div id="text">
        ...
        <img width=350px src={imgGisLayers} alt="gis-layers">
        ...
        <ul class="list">
            <li>QGIS (free and open source, can do most tasks, popular in tech and academia and non-profits)</li>
            <li>ArcGIS (proprietary, can do most tasks, used by big organizations)</li>
        </ul>
        <p>Web-based GIS and mapping</p>
        <ul class="list">
            <li>MapBox (commercial, free basic accounts)</li>
    ...
    <div id="text">
        <p>Let's start playing with some data in QGIS.</p>
        <p>Sample data for some of the following tutorials can be downloaded from <a href="https://github.com/schoolofcities/mapping-workshops-2023/raw/main/notebooks/qgis-intro/qgis-intro.zip" target="_blank">here</a>.</p>
    </div>
    ...
    <div id="text">
        ...
        <ul>
            ...
            <li><a href="https://open.toronto.ca/dataset/bike-share-toronto/" target="_blank">Bike Share Stations</a>. This data are a "live" <code>json</code> feed, I've scraped it and included it in the download link above.</li>
        </ul>
        <p>
        ...
        <p>
            We can change the colours and style of each layer by right-clicking on a layer, going to <i>Properties</i>, and then <i>Symbology</i>. In the image above, I changed the colours of the two vector layers, as well as the stroke-width of the Centreline layer.
        </p>
        <p> 
    ...
    <div id="text">
        ...
        <p>This map was exported by going to <i>Project</i>, selecting <i>New Print Layout</i>, and then adding in a map view, legend, and scale bar to the blank page.</p>
    ...
    <div id="text">
        ...
        <ul>
            ...
            <li>Apartment Buildings (originally geocoded from the City's apartment building registration and evaluation data on <a href="https://open.toronto.ca/catalogue/?search=apartment%20buildings&sort=score%20desc" target="_blank">Open Data Toronto</a>). Included in the <code>.zip</code> file linked to above</li>
        </ul>
